...
export default function PopularCities() {
  return (
    <div className="w-full">
      <div className="text-gray-50 bg-[#ffffff2b] mx-auto sm:max-w-[240px] h-full flex flex-col justify-center items-start p-4 gap-6 rounded-md">
        ...
        <div className="flex gap-4  flex-col">
          <div className="flex gap-5 items-center  justify-between">
            ...
            <p className="text-[13px] text-[#ffffffd6] items-end">Partly Cloudy</p>
          </div>
          <div className="flex gap-5 items-center justify-between ">
